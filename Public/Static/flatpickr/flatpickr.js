...
function Flatpickr(element, config) {
	...
	function positionCalendar() {
        ...
        distanceFromBottom = window.innerHeight - inputBounds.top;
      var mainCon = $('.mainContent'),
      mainConBounds = mainCon.offset().top;
		var top = void 0,
		    // left = window.pageXOffset + inputBounds.left -  inputBounds.left;
             left =inputBounds.left- mainCon.offset().left;
		...
		if (distanceFromBottom < calendarHeight) {
			...
			top = inputBounds.bottom  - mainConBounds+ 2;
            // top = inputBounds.top;
