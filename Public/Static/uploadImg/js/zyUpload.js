		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				var html= '';
				    ...
				    html += '							<img style="height: 100%" class="upload_image" src="/Public/Static/uploadImg/image/add.png"  />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				if (file.type.indexOf("image") == 0) {
					...
					html += '		</div>';
					html += '	</div>';
					html += '	<a style="height:206px;width: 138px" href="#" class="imgBox">';
					html += '		<div class="uploadImg" style="margin: 0">';
					...
					html += '		<div class="uploadImg uploadImg1" style="margin: 0">';
