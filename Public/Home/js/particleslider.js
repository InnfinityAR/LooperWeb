function ParticleSlider(a) {
    ...
    if (a) {
        ...
        for (var d = 0,
        e = c.length; d < e; d++) a[c[d]] && (b[c[d]] = a[c[d]])
    }
    ...
    b.shuffle = function() {
        var a, b;
        for (var c = 0,
        d = this.length; c < d; c++) b = Math.floor(Math.random() * d),
        a = this[c],
        this[c] = this[b],
        this[b] = a
    },
    ...
    if (b.imgs.length == 0) for (var d = 0,
    e = b.$$slides.length; d < e; d++) {
        var f = new Image;
        b.imgs.push(f),
...
ParticleSlider.prototype.$ = function(a, b, c) {
    ...
    if (a[0] == ".") {
        ...
        var f = [];
        for (var g = 0,
        h = b.length; g < h; g++) b[g].className && b[g].className == e && f.push(b[g]);
...
ParticleSlider.prototype.init = function(a) {
    ...
    if (b.imgs.length > 0) {
        ...
        if (b.showArrowControls == !0) {
            ...
            for (var e = 0,
            f = d.length; e < f; e++) d[e].color = function() {
            ...
            for (var e = 0,
            f = g.length; e < f; e++) g[e].color = function() {
